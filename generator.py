...
NUMBER_OF_FLIGHTS = 2
MIN_AMOUNT_OF_SITS = 3
MAX_AMOUNT_OF_SITS = 4
...
def generate_purchased_ticket(global_ticket_id, flight, flight_ticket):
    ...
    current_file.write(
        "INSERT INTO BILET (id, cena, data_urodzenia, data_wylotu, data_zakupu, id_dokumnetu, identyfikator_biletu,"
        ...
        " VALUES ({}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {})\n".format(ticket.db_id, ticket.price, ticket.date_of_birth,
                                                                            ...
                                                                            ticket.airplane_id, ticket.name, ticket.surname, ticket.document_type))
    return ticket
...
def generation_process():
    ...
    for i in range(1, NUMBER_OF_FLIGHTS + 1):
        ...
        current_file.write(
            "INSERT INTO LOT (id, data_przylotu, data_wylotu, identyfikator_lotu, identyfikator_samolotu, linia_litnicza, miejsce_przylotu, miejsce_wylotu)"
        ...
        for j in range(1, number_of_sits + 1):
            flight_ticket = generate_flight_ticket(global_ticket_id, prev_sit, flight.airline)
            ...
            current_file.write("INSERT INTO BILET_LOT (id, miejsce, rzad, bilet_id, fk_lot_linia_lotnicza, fk_lot_identyfikator_biletu)"
                    " VALUES ({}, {}, {}, {}, {}, {})\n".format(flight_ticket.db_id, flight_ticket.place_number, flight_ticket.row_number, flight_ticket.ticket_id, flight_ticket.flight_ticket_id, flight_ticket.airlines))
            global_ticket_id += 1
            if i < NUMBER_OF_FLIGHTS:
                current_file = f

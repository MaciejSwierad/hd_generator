...
def generate_purchased_ticket(global_ticket_id, flight, flight_ticket):
    ...
    current_file.write(
        ...
        " VALUES ({}, {}, '{}', '{}', '{}', '{}', {}, {}, {}, '{}', '{}', '{}', '{}')\n".format(global_ticket_id, ticket.price, ticket.date_of_birth,
...
def generation_process():
    ...
    #for i in range(1, NUMBER_OF_FLIGHTS + 1):
        ...
        current_file.write(
            "INSERT INTO LOT (id, data_przylotu, data_wylotu, identyfikator_lotu, identyfikator_samolotu, linia_lotnicza, miejsce_przylotu, miejsce_wylotu, oddzial, liczba_miejsc)"
        ...
        for j in range(1, number_of_sits + 1):
            ...
            if generate_with_new_surname():
                ...
                current_file.write(
                    ...
                    " VALUES ({}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {})\n".format(ticket.db_id, ticket.price,
                ...
                current_file.write(
                    ...
                    " VALUES ({}, {}, {}, {}, {}, {})\n".format(flight_ticket.db_id, flight_ticket.place_number,
                                                                flight_ticket.row_number, global_ticket_id,
                                                                global_ticket_id, flight_ticket.airlines))
                if scans[0].scan_date is not None:
                    current_file.write(
                        "INSERT INTO SKAN (id, data, nazwa_czujnika, fk_bilet)"
                        " VALUES ({}, '{}', '{}', {})\n".format(scans[0].id, scans[0].scan_date, scans[0].scanner_name, global_ticket_id))
                    global_scan_id += 1
                if scans[1].scan_date is not None:
                    current_file.write(
                        "INSERT INTO SKAN (id, data, nazwa_czujnika, fk_bilet)"
                        " VALUES ({}, '{}', '{}', {})\n".format(scans[1].id, scans[1].scan_date, scans[1].scanner_name,
                                                            global_ticket_id))

                if baggage.__len__():
                    current_file.write(
                        "INSERT INTO BAGAZ (id, masa, rodzaj, fk_bilet)"
                        " VALUES ({}, {}, {}, {})\n".format(baggage[0].db_id, baggage[0].weight,
